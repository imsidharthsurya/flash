...
const VideoBackground = ({movieId}) => {
  ...
  return (
    <div>
      <iframe className="w-screen aspect-video" src={"https://www.youtube.com/embed/XeDbyVODQ5M?si="+trailerData?.key+"&autoplay=1&mute=1"} title="YouTube video player" allow="autoplay"></iframe>
